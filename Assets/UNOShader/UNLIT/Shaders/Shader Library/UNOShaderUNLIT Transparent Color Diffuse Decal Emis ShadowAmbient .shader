//Version=1.3
Shader"UNOShader/_Library/UNLIT/UNOShaderUNLIT Transparent Color Diffuse Decal Emis ShadowAmbient "
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
			...
			//__________________________________ Shadow _____________________________________
				#ifdef LIGHTMAP_ON
