//Version=1.3
Shader"UNOShader/_Library/UNLIT/UNOShaderUNLIT Emis "
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
			...
			//__________________________________ Emission _____________________________________
				...
				resultRGB = lerp (fixed4(0,0,0,0),fixed4((T_Emission.rgb * _EmissionColor) * _EmissionIntensity,T_Emission.a),_EmissionColor.a);
